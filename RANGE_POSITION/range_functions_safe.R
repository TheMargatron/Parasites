...
range_distances <- function(dat, range.pol, range.dat, method=c("gbif","iucn"), tax=c("species", "sub")){
  if(method == "iucn"){
    ...
    ### Create taxon names and create new columns to be sued...
    ...
    print(c("Hosts without range data are: ", hosts.noGMPD))
